...
class Helper_Image_Resize extends Helper_Abstract
{
    ...
    protected $error = [
        'NO_INPUT'   =>  'нет входного пути',
        'NO_FILE'   =>  'не удается найти файл',
        'NO_OUTPUT'   =>  'нет выходного пути',
        'NO_SIZE'   =>  'некорректные размеры',
        'CANT_CREATE'   =>  'не удается создать изображение',
        'CANT_SAVE' =>  'не удается сохранить изображение',
        'NO_INFO'   =>  'не удается получить информацию об изображении'
    ];
    ...
    /**
	 * Тоже самое, что и resize, но с выводом ошибок
	 *
	 * @param string $input
	 * 		Файл с исходным изображением
	 * @param string $output
